...
function metric(counterName, value, customTypeCode) {
  var metricData = counterName + ':' + value + '|' + customTypeCode
  this._data.push(metricData);
}

function increment(counterName, value) {
  var metricData = counterName + ':' + (value || 1) + '|c';
  this._data.push(metricData);
}
